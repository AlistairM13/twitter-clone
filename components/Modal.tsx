    ...
    return (
        <>
            <div
                ...
                fixed inset-0 z-50 outline-none focus:outline-none backdrop-blur-sm bg-neutral-800/50
                ">
                <div
                    className="relative w-full lg:2-3/6 my-6 mx-aut lg:max-w-3xl h-full lg:h-auto"
                >
                    {/* Content */}
                    <div
